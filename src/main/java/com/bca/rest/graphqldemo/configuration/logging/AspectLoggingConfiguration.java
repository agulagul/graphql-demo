package com.bca.rest.graphqldemo.configuration.logging;
...
public class AspectLoggingConfiguration extends BaseLogging {
    ...
    @Pointcut("(within(@org.springframework.web.bind.annotation.RestController *) || within(@org.springframework.stereotype.Controller *) && !@annotation(com.bca.rest.graphqldemo.util.logging.NoLogging))")
